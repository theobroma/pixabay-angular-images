...
import { ImagesDataType } from './image';
...
export class ImageService {
  ...
  // private URL: string = this.API_URL+"&q=nature&image_type=photo&orientation=horizontal&per_page=12&page=1";

  constructor(private http: HttpClient) { }

  getImages(): Observable<ImagesDataType> {
    ...
    return this.http.get<ImagesDataType>(this.API_URL, { params: params })
      .pipe(
